...
def generar_pdf(
    ...
    tabla_data = [[
        Paragraph("Nº", ParagraphStyle("hd", fontName="Helvetica-Bold", fontSize=10, textColor=BLANCO, alignment=TA_CENTER)),
        Paragraph("Descripción del servicio", ParagraphStyle("hd", fontName="Helvetica-Bold", fontSize=10, textColor=BLANCO)),
        Paragraph("Precio", ParagraphStyle("hd", fontName="Helvetica-Bold", fontSize=10, textColor=BLANCO, alignment=TA_RIGHT)),
    ]]
